#!/usr/bin/env bun
/**
 * code-buddy test-statusline — temporarily install a test status line
 *
...
if (action === "install") {
  console.log(`\n${BOLD}code-buddy test status line installer${NC}\n`);
...
if (action === "restore") {
  console.log(`\n${BOLD}code-buddy test status line restore${NC}\n`);
