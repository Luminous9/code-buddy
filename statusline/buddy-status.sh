...
case "$SPECIES" in
  ...
  axolotl)
    case $FRAME in
      0) L1="}~(______)~{"; L2="}~(${E} .. ${E})~{"; L3="  ( .--. )"; L4="  (_/  \\_)" ;;
      1) L1="~}(______){~"; L2="~}(${E} .. ${E}){~"; L3="  ( .--. )"; L4="  (_/  \\_)" ;;
      2) L1="}~(______)~{"; L2="}~(${E} .. ${E})~{"; L3="  (  --  )"; L4="  ~_/  \\_~" ;;
    esac ;;
  capybara)
    case $FRAME in
  ...
  mushroom)
    case $FRAME in
      0) L1=" .-o-OO-o-."; L2="(__________)"; L3="   |${E}  ${E}|"; L4="   |____|" ;;
      1) L1=" .-O-oo-O-."; L2="(__________)"; L3="   |${E}  ${E}|"; L4="   |____|" ;;
      2) L1=" .-o-OO-o-."; L2="(__________)"; L3="   |${E}  ${E}|"; L4="   |____|" ;;
    esac ;;
  chonk)
    case $FRAME in
      0) L1="  /\\    /\\"; L2=" ( ${E}    ${E} )"; L3=" (   ..   )"; L4="  \`------'" ;;
  ...
  spider)
    case $FRAME in
      0) L1="    /°oo°\\"; L2=" ,.( ¥vv¥ ).,"; L3="//¨\\\\¥¨¨¥//¨\\\\"; L4="uu  U    U  uu" ;;
      1) L1="    /°oo°\\"; L2=" ,.( ¥vv¥ ).,"; L3="//¨\\\\ ¥¥ //¨\\\\"; L4="uu  U    U  uu" ;;
      2) L1="  n /°oo°\\ n"; L2=" ,\\\\ ¥vv¥ //,"; L3="//¨  ¥¨¨¥  ¨\\\\"; L4="uu          uu" ;;
    esac ;;
  *)
    L1="(${E}${E})"; L2="(  )"; L3=""; L4="" ;;
esac
